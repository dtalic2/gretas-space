...
export const SHOP_UNLOCKS = {
  onion:1, carrot:1, garlic:2, lettuce:2, beans:2, potato:3, strawberry:3,
  blueberry:4, tomato:4, wheat:4, corn:5, bellpepper:5, broccoli:6, sunflower:6,
  pumpkin:7, bamboo:7, cucumber:8, aubergine:8, pineapple:9, honeydew:9,
  watermelon:10,
  // perennials
  grapevine:6, appletree:9, cherrytree:11, chestnut:11, orangetree:12,
  lemontree:12, coconut:13, mangotree:14, peartree:15,
};
