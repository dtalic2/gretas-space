...
2. It prints the address to type on your phone. The server already listens on
   ...
   something you can guess.
    ...
    python3 serve.py [port]        # defaults to $PORT, else 8125
"""
import functools
import http.server
import os
...
PORT = int(sys.argv[1]) if len(sys.argv) > 1 else int(os.environ.get('PORT', 8125))
